...
export default function TourRecorridos() {
  ...
  useEffect(() => {
    const mockTours = [
      {
        id: "t1",
        title: "Kayak en Potrerillos",
        author: "Dante Ruiz",
        durationMinutes: 150,
        distanceKm: 8,
        price: 22000,
        description: "Remada guiada en el dique con vistas abiertas y ritmo ideal para parejas o grupos chicos.",
        image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i1",
      ...
      {
        id: "t2",
        title: "Rafting Rio Mendoza",
        author: "Maxi Leguiza",
        durationMinutes: 210,
        distanceKm: 15,
        price: 36000,
        description: "Salida con rapidos, equipo completo y guia profesional para quienes buscan una experiencia intensa.",
        image: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1472396961693-142e6e269027?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i2",
          name: "Drew Binsky",
          avatar:
      ...
      {
        id: "t3",
        title: "Cabalgata en Uspallata",
        author: "Ema Caceres",
        durationMinutes: 180,
        distanceKm: 12,
        price: 18000,
        description: "Recorrido amable entre cerros y valles, pensado para quienes quieren paisaje y una salida relajada.",
        image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i3",
          name: "Charly Sinewan",
          avatar:
      ...
      {
        id: "t4",
        title: "Termas de Cacheuta Full Day",
        author: "Maria Luna",
        durationMinutes: 300,
        distanceKm: 18,
        price: 26000,
        description: "Dia completo de termas, paisaje y descanso para una escapada sin apuro.",
        image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1439853949127-fa647821eba0?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i1",
          name: "Luisito Comunica",
          avatar:
      ...
      {
        id: "t5",
        title: "Trekking en Vallecitos",
        author: "Ana Gomez",
        durationMinutes: 320,
        distanceKm: 18,
        price: 24000,
        description: "Ascenso con tramos exigentes, aire de montania y una experiencia fuerte para gente activa.",
        image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1465311440653-ba9b1d9b0f5b?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i2",
          name: "Drew Binsky",
          avatar:
      ...
      {
        id: "t6",
        title: "Canopy en Potrerillos",
        author: "Sofia Ramirez",
        durationMinutes: 110,
        distanceKm: 5,
        price: 21000,
        description: "Circuito aereo con buenas vistas y sensacion de velocidad, ideal para sumar adrenalina sin irte lejos.",
        image: "https://images.unsplash.com/photo-1527631746610-bca00a040d60?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i3",
          name: "Charly Sinewan",
          avatar:
      ...
      {
        id: "t7",
        title: "Bodega y Bicis en Maipu",
        author: "Lucia Torres",
        durationMinutes: 240,
        distanceKm: 22,
        price: 19500,
        description: "Pedaleo suave entre bodegas con degustacion y un cierre mas gourmet que extremo.",
        image: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i1",
          name: "Luisito Comunica",
          avatar:
      ...
      {
        id: "t8",
        title: "Astroturismo en Malargue",
        author: "Joaquin Perez",
        durationMinutes: 200,
        distanceKm: 14,
        price: 16000,
        description: "Observacion de cielo profundo con guia, telescopio y contexto cientifico para una noche distinta.",
        image: "https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i2",
          name: "Drew Binsky",
          avatar:
      ...
      {
        id: "t9",
        title: "Stand Up Paddle en Carrizal",
        author: "Flor Sosa",
        durationMinutes: 130,
        distanceKm: 6,
        price: 18500,
        description: "Experiencia sobre el agua para quienes quieren algo activo pero no extremo, con muy buena luz para fotos.",
        image: "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?auto=format&fit=crop&w=1200&q=80",
        image2: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1200&q=80",
        influencer: {
          id: "i1",
          name: "Luisito Comunica",
          avatar:
      ...
      {
        id: "t10",
        title: "Safari Fotografico en Nacunan",
        author: "Bruno Diaz",
        durationMinutes: 220,
        distanceKm: 16,
        price: 17500,
        description: "Salida pensada para fauna, paisajes y fotografia tranquila con guia local.",
